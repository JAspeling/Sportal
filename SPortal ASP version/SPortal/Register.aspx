<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SPortal.Register" %>
                                         ...
                                         <div>
                                             <ul style="list-style-type: none;text-decoration: none;">
                                                    <li data-slide-name="slide-one">
                                                        <div style=" width: 855px; height: 600px; background-image: url('img-demo/RegisterBack.jpg');">
                                                           <div style="padding-top: 120px;margin-left: 10%;">
                                                               ...
                                                               <div style="color: #c0c0c0; height: 300px; width: 300px; background-color: transparent; float: right; margin-top: -54.3%; margin-right: 10%">
