                ...
                <ul style="list-style-type: none; text-decoration: none;">
                    <li data-slide-name="slide-one">
                        <div style="background-color: white; width: 855px;">
                            ...
                            <div>
                                <div style="margin-left: 10%;">
                                    <div style="height: auto">
                                        ...
                                        <div style="background-color: transparent; color: #1f92cb; float: right; float: right; height: 300px; margin-right: 10%; width: 300px;">
                            ...
                            <div style="margin-top: 30px; width: 855px; height: 1px">
