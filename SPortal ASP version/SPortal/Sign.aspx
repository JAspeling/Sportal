<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign.aspx.cs" Inherits="SPortal.Sign" %>
...
<body>
    ...
    <div>
		                              <div style="color: #ffffff; width: 100%;height: 100%;position: fixed;bottom: 0px;right: 0px; top: 0px; background-image: url('images/sign_Back.png');">
                                        <div style=" padding-left: 30%; padding-top: 5%; padding-right: 50%; padding-bottom: 10%; height: 600px; width: 680px">
