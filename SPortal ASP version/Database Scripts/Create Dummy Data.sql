...
INSERT INTO Topic (TopicName, TopicDescription, TopicBody, CreationDate, Upvotes, Downvotes, AmountOfPosts) VALUES ('A Beginner''s Tutorial for Understanding Windows Communication Foundation (WCF)', 'This article is an introduction to the Windows Communication Foundation (WCF). We will try to see the basic concepts behind WCF and will try to implement a small WCF service. We will also work out some small examples of how a WCF service can be consumed.', 'This is the body of the topic', CONVERT(DATE,GETDATE()), 0, 0, 0);
INSERT INTO Topic (TopicName, TopicDescription, TopicBody, CreationDate, Upvotes, Downvotes, AmountOfPosts) VALUES ('Basic Introduction/Tutorial to writing sockets in C#', 'Is there any basic tutorial to writing sockets in c#? I have looked around for a while and still have not found a in-depth tutorial about how to go doing it..
